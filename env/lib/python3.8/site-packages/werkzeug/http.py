...
def parse_date(value: t.Optional[str]) -> t.Optional[datetime]:
    ...
    try:
        dt = mailings.utils.parsedate_to_datetime(value)
...
def http_date(
    ...
    if isinstance(timestamp, date):
        ...
        return mailings.utils.format_datetime(timestamp, usegmt=True)

    if isinstance(timestamp, struct_time):
        timestamp = mktime(timestamp)

    return mailings.utils.formatdate(timestamp, usegmt=True)
